...
export const CreateCustomerAddressBody = zod.object({
  addressType: zod.enum(["billing", "delivery"]).optional(),
  label: zod.string().nullish(),
  street: zod.string(),
  district: zod.string().nullish(),
  city: zod.string(),
  postalCode: zod.string(),
  country: zod.string(),
  isDeliveryAddress: zod.boolean().optional(),
...
export const ListDeliveriesResponseItem = zod.object({
  ...
  deliveryAddressId: zod.number().nullish(),
  driverId: zod.number().nullish(),
  driverName: zod.string().nullish(),
  scheduledDate: zod.string().nullable(),
  plannedSequence: zod.number().nullish(),
  plannedByUserId: zod.number().nullish(),
  status: zod.enum([
    "unassigned",
    "assigned",
    "arrived",
